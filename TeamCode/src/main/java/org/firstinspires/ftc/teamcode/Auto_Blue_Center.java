...
@Autonomous(name="Auto_Blue_Center", group="Mecanum Drive")
public class Auto_Blue_Center extends LinearOpMode {
    ...
    public void moveForward(double tiles, double speed) throws InterruptedException {
        ...
        Thread.sleep(3000); //todo: I'll see what happens with 5000 - may be enough to pull offsimple autonomous
    }
